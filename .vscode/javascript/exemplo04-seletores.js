// O que é a função: função é um trecho de código que tem como objetivo resolver algum problema
...
function acaoBotaoApresentarOcultar() {
    let divTag = document.querySelector("#div-apresentada");
    // Se a div for ocultada devo apresentar
...
function alterarCorDiv() {
    alert("o click chegou até aqui")
    let div = document.querySelector(".div-cor-azul")
    div.style.backgroundColor = "aqua"; 7
